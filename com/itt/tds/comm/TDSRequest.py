...
try:
    from com.itt.tds.comm.TDSProtocol import TDSProtocol
    ...
    if log:
        log.log_warn(
            'TDSRequest', 'Import Module', error.__str__(), str(error))
...
class TDSRequest(TDSProtocol):
    ...
    def set_protocol_type(self, request_type):
        """
            ...
            Return Type : None.
        """
        self.protocol_type = request_type

    def get_protocol_format(self):
        """
            Description : Function to get protocol format of request which sent
            to server.

            Return Type : It returns protocol_format of request object.
        """
        return self.protocol_format

    def set_protocol_format(self, protocol_format):
        """
            Description : Function to set protocol_format of request object
            which sent along with request.
    ...
    def get_protocol_version(self):
        """
            Description : Function to get protocol version of request which sent
            to server.

            Return Type : It returns protocol_version of request object.
        """
        return self.protocol_version

    def set_protocol_version(self, protocol_version):
        """
            Description : Function to set protocol_version of request object
            which sent along with request.
